...
const detalleVentasService = {
  ...
  async actualizarDetalleVenta(id, venta) {
    try {
  ...
  async actualizarEstadoDetalleVenta(id, estado, fechaEntrega = null) {
    try {
      const data = {
        estado: estado,
